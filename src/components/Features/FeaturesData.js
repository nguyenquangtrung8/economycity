...
const featureData = [
    {
      ...
      description:
        'Tọa lạc tại trung tâm thị trấn Như Quỳnh, huyện Văn Lâm, cách trung tâm Hà Nội 18km, cách Ocean Park 5km với kết nối trực tiếp đến Quốc lộ 5A, Vành đai 3.5 và Vành đai 4.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Đô thị hiện đại 37ha với quảng trường trung tâm 5.6ha, hồ điều hòa 1.2ha, clubhouse 2.000m² và hệ thống 30 tiện ích đồng bộ đáp ứng mọi nhu cầu sinh hoạt.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Với giá chỉ từ 107 triệu/m² (thấp hơn 35% so với dự án Vinhomes trong khu vực), pháp lý đầy đủ với sổ đỏ sở hữu lâu dài và tiềm năng tăng giá khi Văn Lâm lên thành phố năm 2030.',
      benefits: [
